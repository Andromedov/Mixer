...
* **🎛️ Audio Effects (DSP):** Apply effects like `Gain`, `Flanger`, `HighPass`, and `LowPass` filters to each Jukebox individually.
...
* **🌐 Wide Source Support:** Works with YouTube, SoundCloud, Bandcamp, Twitch, Cobalt, and direct HTTP links.
